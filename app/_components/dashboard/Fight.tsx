...
export function Fight({ data }: Readonly<Props>) {
  return (
    <div className="mx-auto mb-4 w-full border-b border-content/5 pb-4 text-xl">
      <div className="mb-4 grid w-full grid-cols-3 font-bold uppercase">
        <div className="inline-flex flex-col items-start">
          ...
          {data.winner === data.redFighterId && <WinnerLabel />}
        </div>
        ...
        <div className="inline-flex flex-col items-end">
          ...
          {data.winner === data.blueFighterId && <WinnerLabel />}
        </div>
      </div>
